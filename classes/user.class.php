<?php
	class User {
		...
		public function createUser($user_data){
			...
			$sec_password = password_hash($user_data['password'].$this->salt, PASSWORD_DEFAULT);
		...
		public function loginUser($user_data) {
			...
			if ($attempt && password_verify($user_data['password'].$this->salt, $attempt['password']) && !$isLocked) {
